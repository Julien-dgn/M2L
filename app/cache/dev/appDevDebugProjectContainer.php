...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\wamp\\www\\Symfony\\src\\BTS2\\BlogBundle\\Entity', 1 => 'C:\\wamp\\www\\Symfony\\src\\BTS2\\UserBundle\\Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'BTS2\\BlogBundle\\Entity');
        $f->addDriver($e, 'BTS2\\UserBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('BlogBundle' => 'BTS2\\BlogBundle\\Entity', 'BTS2UserBundle' => 'BTS2\\UserBundle\\Entity'));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'BTS2\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\BTS2\\BlogBundle/Resources/views', 'Blog');
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\LIGUES\\PlatformBundle/Resources/views', 'LIGUESPlatform');
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\BTS2\\UserBundle/Resources/views', 'BTS2User');
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\AchatVente\\BlogBundle/Resources/views', 'AchatVenteBlog');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_WRITER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BlogBundle' => 'BTS2\\BlogBundle\\BlogBundle',
                'LIGUESPlatformBundle' => 'LIGUES\\PlatformBundle\\LIGUESPlatformBundle',
                'BTS2UserBundle' => 'BTS2\\UserBundle\\BTS2UserBundle',
                'AchatVenteBlogBundle' => 'AchatVente\\BlogBundle\\AchatVenteBlogBundle',
